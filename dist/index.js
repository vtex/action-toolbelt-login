...
;// CONCATENATED MODULE: ./lib/create-session.js
...
const getAuthToken = async ({ appkey, apptoken, account, }) => {
    ...
    const fetch = await __nccwpck_require__.e(/* import() */ 841).then(__nccwpck_require__.bind(__nccwpck_require__, 2841)).then((mod) => mod.default);
