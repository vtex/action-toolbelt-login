...
const getAuthToken = ({ appkey, apptoken, account }) => __awaiter(void 0, void 0, void 0, function* () {
    const payload = {
        appkey,
        apptoken
    };
    const res = yield (0, node_fetch_1.default)(`http://api.vtexcommercestable.com.br/api/vtexid/apptoken/login?an=${encodeURIComponent(account)}`, {
        method: 'POST',
...
const createSession = ({ appkey, apptoken, account }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!(0, fs_1.existsSync)(sessionDirectory)) {
        yield io.mkdirP(sessionDirectory);
    }
    yield Promise.all([
...
const create_session_1 = __nccwpck_require__(259);
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const token = yield (0, create_session_1.createSession)({
                appkey: appKey,
                apptoken: appToken,
                account
            });
